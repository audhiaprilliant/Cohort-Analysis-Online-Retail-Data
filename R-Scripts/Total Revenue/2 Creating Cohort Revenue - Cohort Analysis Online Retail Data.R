# ===== CREATING COHORT - COHORT ANALYSIS REVENUE =====

# READ THE DATA
cohort2011 = read.csv(file = 'D:/Audhi Aprilliant/IPB Works/Statistics Department/Data Science Practices/Projects/Cohort Analysis - Online Retail Data/Datasets/Total Revenue/1 cohort2011.csv',
                      header = TRUE,
                      sep = ',')
str(cohort2011)
View(cohort2011)
...
write.csv(x = cohort2011,
          file = 'D:/Audhi Aprilliant/IPB Works/Statistics Department/Data Science Practices/Projects/Cohort Analysis - Online Retail Data/Datasets/Total Revenue/2 cohort2011 Cohort Formed.csv',
          row.names = FALSE)
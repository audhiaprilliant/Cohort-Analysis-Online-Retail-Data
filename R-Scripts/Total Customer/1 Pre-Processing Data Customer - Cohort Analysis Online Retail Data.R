...
# READ THE DATA
data.cohort = read.delim2('clipboard')
# SAVE THE DATA INTO CSV FILE
write.csv(x = data.cohort,
          file = 'D:/Audhi Aprilliant/IPB Works/Statistics Department/Data Science Practices/DATASETS/Market Basket Analysis/Online Retail/Online Retail Data.csv',
          row.names = FALSE)
# LOAD THE DATA
...
write.csv(x = cohort2011,
          file = 'D:/Audhi Aprilliant/IPB Works/Statistics Department/Data Science Practices/Projects/Cohort Analysis - Online Retail Data/Datasets/cohort2011.csv',
          row.names = FALSE)